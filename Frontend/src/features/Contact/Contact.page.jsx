...
const Contactpage = () => {
    return (
        <div className='w-full overflow-x-hidden'>
            <section className="bg-transparent dark:bg-transparent overflow-y-hidden w-full ">
                <div className="container px-6 py-12">
                    <div className="text-center ">
                        ...
                        <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">We’d love to
                            hear
                            from you</h1>
                    ...
                    <img className="object-cover w-full h-64 mt-10 rounded-lg lg:h-96"
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2">
                        ...
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">100 Smith Street Collingwood VIC
                                3066
                                AU</p>
                        </div>
            ...
            <section className="min-h-screen bg-white dark:bg-transparent text-black">
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:flex lg:items-center lg:-mx-10">
                        <div className="lg:w-1/2 lg:mx-10">
                            <h1 className="text-2xl font-semibold text-gray-800 capitalize dark:text-black lg:text-3xl">Let’s
                                talk</h1>
                        ...
                        <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                            <img className="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96"
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                <p className="flex items-start -mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        className="w-6 h-6 mx-2 text-blue-500 dark:text-black" fill="none"
                                    ...
                                    <span className="mx-2 text-gray-700 truncate w-72 dark:text-black">
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span
                                        className="mx-2 text-gray-700 truncate w-72 dark:text-glack">(257) 563-7401</span>
                                </p>
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span
                                        className="mx-2 text-gray-700 truncate w-72 dark:text-glack">acb@example.com</span>
                                </p>
                            </div>
                            ...
                            <div className="mt-6 w-80 md:mt-8">
                                ...
                                <div className="flex mt-4 -mx-1.5 ">
                                    <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                                        href="#">
                                        <svg className="w-10 h-10 fill-current" viewBox="0 0 24 24" fill="none"
